...
const previewContent = {
  en: {
    ...
    subtitle:
      "This page explains what the main areas of FormaVeris do before the user enters the application workspace.",
  ...
  hu: {
    ...
    subtitle:
      "Ez az oldal bemutatja, hogy a FormaVeris fő felületei mire szolgálnak, mielőtt a felhasználó belépne az alkalmazás workspace-ébe.",
